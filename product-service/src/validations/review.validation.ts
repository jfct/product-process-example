...
export const createReviewValidation = [
    ...
    body('rating').isInt({ max: 5, min: 1 }).withMessage('Rating must be integer within (0-5)'),
...
export const updateReviewValidation = [
    ...
    body('rating').optional().isInt({ max: 5, min: 1 }).withMessage('Rating must be within (0-5) and with a single decimal digit'),
];
